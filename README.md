...
##  技术涉及
 ...
 -  项目文件布局：
     - CMSandInterface： 后台管理系统及供移动端调用的ajax接口，用IDEA打开。
    -  wap: 移动端前端工程，用vscode或者webstorm打开。
...
3. 用户名和密码都是123456,部署不成功可以通过下方邮箱联系作者。
4. **项目备注**： 周一到周五显示本周菜单，周末显示下周菜单，发现选菜页面没有东西的同学注意啦！！！
