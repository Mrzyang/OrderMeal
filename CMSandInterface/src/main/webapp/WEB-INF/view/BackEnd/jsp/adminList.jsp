            ...
            <div class="search-content">
                <form action="/admin/school" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">员工号:</th>
                            <td><input class="common-text" placeholder="员工号" name="keyword" value="${keyword}" id="" type="text"></td>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="administrator?&type=addUI"><i class="icon-font"></i>添加管理员信息</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <c:forEach var="item" items="${list}">
                            <tr>
                                <td class="tc"><input name="adminId" value="${item.adminId}" type="checkbox" class="singleChoose"></td>
                                <td>${item.adminNum}</td>
                                <td>
                                    <input type="radio" name="adminType" value="3" ${item.adminType=="3"?'checked':''}>系统管理员</input>
                                    <input type="radio" name="adminType" value="2" ${item.adminType=="2"?'checked':''}>生产者</input>
                                    <input type="radio" name="adminType" value="1" ${item.adminType=="1"?'checked':''}>配送者</input>
                                </td>
                                <td>
                                    <a  href="admin?&type=updateUI" class="btn btn-primary btn2">修改</a>
                                    <button type="button" onclick="singleDelete(${item.adminId},${pageNum})" class="btn btn-danger btn2">删除</button>
                                </td>
                            </tr>
                        </c:forEach>
